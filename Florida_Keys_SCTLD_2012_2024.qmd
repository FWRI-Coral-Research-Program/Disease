...
## Create a SumOfAllDisease column

```{r}
# Create our SumofAllDisease column
fk_sctld_filtered <- fk_sctld_filtered %>%
  mutate(SumOfAllDisease = rowSums(
    select(., SumOfDSD, SumOfWPL, SumOfWPX, SumOfBBD, SumOfWBD, SumOfRBD, SumOfYBD), # replace with your disease columns
    na.rm = TRUE
  ))
```
...
sf_sctld_filtered <- sf_sctld_filtered %>%
  mutate(SumOfAllDisease = rowSums(
    select(., SumOfDSD, SumOfWPX, SumOfBBD, SumOfWBD, SumOfRBD, SumOfYBD), # replace with your disease columns
    na.rm = TRUE
  ))
```
...
fk_sctld_filtered <- fk_sctld_filtered %>%
  rename(fk_disease = SumOfAllDisease,
         SumOfWhite_Plauge = SumOfWPL)

sf_sctld_filtered <- sf_sctld_filtered %>%
  rename(sf_disease = SumOfAllDisease,
         SumOfDisease_Outbreak = SumOfDOB)
...
combined_species<- combined_species %>%
  mutate(SumOfAllDisease = rowSums(
    select(., SumOfDSD, SumOfWPX, SumOfWPL, SumOfBBD, SumOfWBD, SumOfRBD, SumOfYBD), # replace with your disease columns
    na.rm = TRUE
  ))
